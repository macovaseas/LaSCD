...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        image_file = image_folder + '/' + line["image"]
        qs = line["text"]
        cur_prompt = qs
        ...
        with torch.inference_mode():
            output_dict = model.generate(
                input_ids,
                images=images_tensor.unsqueeze(0).half().cuda(0),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-folder", type=str, default="/hpc2hdd/home/fcao628/dataset/val2014")
    parser.add_argument("--question-file", type=str, default="/hpc2hdd/home/fcao628/VCD/experiments/data/POPE/coco/coco_pope_adversarial.json")
    parser.add_argument("--answers-file", type=str, default="/hpc2hdd/home/fcao628/Deco/output/coco/adversarial.json")
