...
if __name__ == "__main__":
    ...
    args = get_args()
    GT = get_gt(data_path='/hpc2hdd/home/fcao628/LLaVA/playground/data/eval/MME/MME_Benchmark_release_version/MME_Benchmark') # /path/to/experiments/data/MME_Benchmark_release_version')
